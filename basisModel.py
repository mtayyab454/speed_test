...
class baseModel(nn.Module):
    def __init__(self, model, use_weights, add_bn, trainable_basis, replace_fc):
        ...
        replace_layer(self.model, use_weights, add_bn, trainable_basis, replace_fc)
...
class basisModel(baseModel):
    ...
    def __init__(self, model, use_weights, add_bn, trainable_basis, replace_fc = False):
        super(basisModel, self).__init__(model, use_weights, add_bn, trainable_basis, replace_fc)
