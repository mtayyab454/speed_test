...
class basisConv2d(nn.Module):
    def __init__(self, org_conv, basis_channels, use_weights=True, add_bn = True, trainable_basis=True):
...
class basisLinear(nn.Module):
    def __init__(self, org_linear, basis_features, use_weights=True, add_bn = True, trainable_basis=True):
